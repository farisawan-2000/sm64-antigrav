const GeoLayout bob_area_1_MY_LEVEL[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ANIMATED_PART(1, 0, 0, 0, NULL),
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(1, -394, 1380, -1674, NULL),
			GEO_OPEN_NODE(),
				GEO_ANIMATED_PART(1, 0, 612, 0, bob_Cube_mesh),
				GEO_ANIMATED_PART(1, 16, -38, 32, bob_Cylinder_mesh),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
...
const GeoLayout bob_area_1_level[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(1, -394, 1380, -1674, -394, 1167, -1674, geo_camera_main),
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, bob_area_1_MY_LEVEL),
					GEO_RENDER_OBJ(),
